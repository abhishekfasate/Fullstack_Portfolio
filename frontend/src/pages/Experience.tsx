...
// const EXPERIENCES = [
//   {
//     company: "Coriolis Technologies - Pune",
//     role: "Software Engineer",
//     duration: "2021 – Present · 4 years",
//     description:
//       "Key projects and contributions from my professional career spanning test automation, DevOps, full-stack development, and team leadership.",
...
//           "Automated linting and code quality checks across frontend and backend codebases using Pylint, ESLint, and Prettier integrated into GitLab CI/CD pipelines. This enforced consistent coding standards team-wide and reduced review cycles by catching style and quality issues before code review.",
//         impact:
//           "Improved code consistency across the entire engineering team.",
//       },
//       {
//         title: "Cypress UI Automation Framework",
//         tags: ["Cypress", "Docker", "Kubernetes", "Test Automation"],
...
//           "Led end-to-end development of two internal full-stack dashboards an HR Dashboard for managing employee data, leave, and reporting, and a Performance Dashboard for tracking individual and team KPIs. Built the backend with Django REST Framework and the frontend with React and Ant Design. Deployed behind Nginx with Gunicorn as the WSGI server.",
//         impact:
//           "Delivered two production internal tools used by HR and management teams.",
//       },
//       {
//         title: "Team Leadership & Agile Collaboration",
//         tags: ["Mentoring", "Code Review", "Agile", "Scrum"],
...
//           "Mentored junior developers through pair programming sessions and structured code reviews, helping them ramp up on both the codebase and engineering best practices. Actively participated in Agile sprint planning, backlog grooming, and retrospectives. Collaborated across frontend, backend, QA, and product teams to ensure smooth feature delivery.",
//         impact:
//           "Contributed to cross-functional delivery and team capability growth.",
//       },
//     ],
//   },
...
//     description:
//       "Built personal and freelance projects focused on backend engineering, DevOps, automation, and scalable system design.",

//     contributions: [
//       {
//         title: "Real-Time Feature Flag Platform",
//         tags: [
//           "Django",
//           "React",
//           "Redis",
...
//         ],
//         description:
//           "Developed a real-time feature flag and experimentation platform supporting gradual rollouts, environment-based configurations, and dynamic flag evaluation APIs. Designed scalable backend services and reusable SDK architecture for application integration.",
//         impact:
//           "Enabled controlled feature releases and safer production deployments.",
//       },
//       {
//         title: "Password Manager Browser Extension",
//         tags: ["JavaScript", "Chrome Extension", "Security"],
//         description:
//           "Built a browser extension for securely storing and auto-filling credentials across websites. Implemented encrypted local storage and a lightweight authentication flow for secure access.",
//         impact:
//           "Improved credential management and reduced repetitive manual logins.",
//       },
//       {
//         title: "Portfolio & Developer Dashboard",
//         tags: ["React", "TailwindCSS", "Framer Motion"],
//         description:
//           "Designed and developed a modern portfolio website with animated UI components, responsive layouts, dark mode support, and reusable frontend architecture.",
//         impact:
//           "Created a professional developer brand and project showcase platform.",
//       },
//     ],
//   },
// ];
...
//           <section key={exp.company} className="mb-24">
//             {/* Header */}
//             <motion.div
//               initial={{ opacity: 0, y: 20 }}
//               animate={{ opacity: 1, y: 0 }}
